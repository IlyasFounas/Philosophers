...
/*   Updated: 2025/07/24 13:20:45 by ifounas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	philo_threads_release_forks(t_philo_threads *philo_threads)
{
	...
	pthread_mutex_unlock(&philo_threads->philo->all_mutex.forks[philo_threads->fork1]);
	pthread_mutex_unlock(&philo_threads->philo->all_mutex.forks[philo_threads->fork2]);
}

void	philo_routine_take_fork(t_philo_threads *philo_threads, int nb_fork)
{
	pthread_mutex_lock(&philo_threads->philo->all_mutex.forks[nb_fork]);
